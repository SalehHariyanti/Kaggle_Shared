...
def main():
    ...
    if USER == 'antor':
        ...
        compare_submissions([os.path.join(submissions_dir, 'submission_DSB2018_512_512_True_12_28_400_0.3_t_nsb_semantic_bw_dim_o-tf-gauss--0.2--horiz-True-rots-True-verti-True_0.5_None_20180411093443_.csv'),
