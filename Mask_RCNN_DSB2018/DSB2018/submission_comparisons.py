...
def main():
    ...
    compare_submissions([os.path.join(submissions_dir, 'submission_scaled_DSB2018_512_512_True_12_28_256_0.3_gment_2inv_dim_o-tf-horiz-True-verti-True_0.5_None_20180403212626_.csv'),
