...
def main():
    ...
    compare_submissions([os.path.join(submissions_dir, 'submission_mosaics_DSB2018_512_512_True_12_28_256_0.3_gment_double_invert_dim_o-tf-horiz-True-verti-True_0.5_22_20180405164806_.csv'),
