...
import os
from settings import train_dir, data_dir, group_id_file
import pandas as pd
...
class DSB2018_Dataset(utils.Dataset):
    ...
    def add_nuclei(self, root_dirs, mode, split_ratio=0.9, shuffle = True, target_colour_id = None):
        # Add classes
...
def get_ids(file_id):
    ...
    """
    assert os.path.exists(group_id_file)
